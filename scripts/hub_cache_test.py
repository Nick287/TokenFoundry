...
Usage (pure stdlib, python-dotenv optional):
    python scripts/hub_cache_test.py                       # all three
    python scripts/hub_cache_test.py --provider anthropic  # just one
    python scripts/hub_cache_test.py --turns 6 --prefix-tokens 3000
